...
let links = ["Fragment", "Scarab", "Fossil", "Resonator", "Essence", "DivinationCard", "Prophecy", "UniqueMap", /*"Map",*/ "UniqueJewel", "UniqueFlask", "UniqueWeapon", "UniqueArmour", "UniqueAccessory"]
let whatever = {};
